...
fr =
  ...
  emailResetLink: "Envoyer l'email de réinitialisation"
  ...
  info:
    ...
    emailVerified: "Adresse email verifiée"
...
#"A login handler should return a result or undefined": "Un gestionnaire d'authentification doit retourner un résultat ou undefined"
      ...
      "Email doesn't match the criteria.": "L'adresse email ne correspond pas aux critères."
